...
| Term | Definition |
|------|------------|
| **Conventional Commits** | Commit message format: `type: subject` (e.g. `feat: add validator`) |
| **Co-authored-by** | Git trailer crediting multiple authors on one commit |
...
**repomark** - `@topdaily-dev/repomark` README health CLI.
