...
Keep commits attributed to **your GitHub accounts only** G«ˆ never Cursor, `@cursoragent`, or other agent identities.

## Checklist (do once per machine)

- [ ] **Cursor IDE:** Settings GÂ∆ **Agents GÂ∆ Attribution** GÂ∆ turn **Commit** and **PR** attribution **off**
- [ ] **Cursor IDE:** Settings GÂ∆ **Git & PRs GÂ∆ Attribution** GÂ∆ turn both **off**
